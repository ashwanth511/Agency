...
const AudienceSection = () => {
  ...
  return (
    <section className="h-screen bg-freelancer_orange grid place-items-center relative audience-section">
      <div className="text-[7.5rem] font-medium leading-[7.625rem] tracking-[-0.15rem] text-center">
        <MaskText phrases={mainText} tag="h1" />
      </div>

      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full space-y-[19rem]">
        <div className="w-[50%] mx-auto flex items-center justify-between">
          <div
            ref={handlePillRef(0)}
            className="flex items-center bg-black gap-2 p-2 rounded-lg"
          >
            <Image src={freelancer} alt="Freelancer logo" className="w-6" />
            <span className="text-xl leading-[-0.025rem]">Freelancers</span>
          </div>
          <div
            ref={handlePillRef(1)}
            className="flex items-center bg-black gap-2 p-2 rounded-lg"
          >
            <Image src={book} alt="Book logo" className="w-6" />
            <span className="text-xl leading-[-0.025rem]">Students</span>
          </div>
        </div>
        <div className="w-[70%] mx-auto flex items-center justify-between">
          <div
            ...
            className="flex items-center bg-black gap-2 p-2 rounded-lg"
          >
            <Image src={monitor} alt="Remote worker logo" className="w-6" />
            <span className="text-xl leading-[-0.025rem]">Remote workers</span>
          </div>
          <div
            ref={handlePillRef(3)}
            className="flex items-center bg-black gap-2 p-2 rounded-lg"
          >
            <Image src={corporate} alt="Corporate logo" className="w-6" />
            <span className="text-xl leading-[-0.025rem]">
              Corporate employees
            </span>
          </div>
        </div>
